...
import (
	...
	"github.com/WSILabs/dicom/pkg/uid"
...
var (
	...
	errorDeflatedTransferSyntaxUnsupported = errors.New("deflated explicit vr little endian transfer syntax not yet support on write (https://github.com/WSILabs/dicom/issues/323)")
)
