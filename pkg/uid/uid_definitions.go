...
var uidMap = map[string]Info{
	...
	// --- WSILabs fork additions: transfer syntaxes added to DICOM after v1.1.0's dictionary was generated ---
	// JPEG XL (Sup 235). go.mod-replace consumers (wsitools) frame-copy these into WSM PixelData.
	"1.2.840.10008.1.2.4.110": {"1.2.840.10008.1.2.4.110", "JPEG XL Lossless", TypeTransferSyntax, "", ""},
	"1.2.840.10008.1.2.4.111": {"1.2.840.10008.1.2.4.111", "JPEG XL JPEG Recompression", TypeTransferSyntax, "", ""},
	"1.2.840.10008.1.2.4.112": {"1.2.840.10008.1.2.4.112", "JPEG XL", TypeTransferSyntax, "", ""},
	// High-Throughput JPEG 2000 (Sup 232). Mirrors upstream PR #377 (suyashkumar/dicom).
