...
import (
	...
	"github.com/WSILabs/dicom/pkg/debug"
...
func (r *reader) readValue(t tag.Tag, vr string, vl uint32, isImplicit bool, d *Dataset, fc chan<- *frame.Frame) (Value, error) {
	...
	// https://github.com/WSILabs/dicom/issues/220
	// and
	// https://github.com/WSILabs/dicom/issues/231.
...
// see https://github.com/WSILabs/dicom/issues/349 for details.
